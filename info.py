...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<code>{file_caption,file_name}</code> \n\n®️: [ᴀʀʀᴏᴡғʟɪx](https://t.me/TorrentSeriess)</b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "<code>{file_caption,file_name}</code> \n\n®️: [ᴀʀʀᴏᴡғʟɪx](https://t.me/TorrentSeriess)</b>")
