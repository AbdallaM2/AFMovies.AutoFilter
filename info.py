...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1002080860092').split()]
...
# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "43000"))
